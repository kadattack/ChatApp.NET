# ChatApp.NET
ChatApp.NET is a real time web chat application created in .NET 6 with Angular and PostgreSQL. The app is based on a Django tutorial StudyBud:
...
- [ ] Add string length checks. Currently there is no length limit input on all forms, both client and server side.
